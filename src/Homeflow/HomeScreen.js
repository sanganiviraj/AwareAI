...
const HomeScreen = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            const response = await axios.post("https://nodewithcrud.onrender.com/analyze", formData, {
                headers: {
    ...
    return (
        ...
        >
            ...
            />
            <Button title="Analyze Product" onPress={handleAnalyze} disabled={loading} />
            ...
            {users.length > 0 ?
                    ...
                    renderItem={({ item, index }) => {
                        return (
                            <View style={styles.usrlist}>
                                ...
                                <Text style={{ color: 'black' }} onPress={() => { dispatch(deleteuser(index)) }}>Delete </Text>
                ...
                /> :
                <Text style={styles.notavailablestyle}>
                    Not available
                </Text>
            }
        </View>
