    ...
    <View style={styles.container}>
      <View style={styles.headerContent}>
        <TouchableOpacity
          ...
          <Image style={styles.backbutton} source={images.backarrow} />
        </TouchableOpacity>
        <Text style={styles.screenTitle}>Product Review</Text>
      </View>
      <KeyboardAvoidingView
        style={{flex: 1}}
        ...
        <ScrollView
          ...
          {analyze ? (
            <View>
              ...
              <Nutriention
                nutrient={response && response.nutrientComposition}
              />
              ...
              <ProductInfo
                sideEffects={response && response.sideEffects}
                StorageInstructions={response && response.storageInstructions}
                UsageInstructions={response && response.usageInstructions}
                UserQuestion={response && response.userQuestionResponse}
                expiryDate={response && response.expiryDate}
                productBenefits={response && response.productBenefits}
